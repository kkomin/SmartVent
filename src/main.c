...
void main() {
    ...
    while(1) {
        ...
        save_environment_data(conn, timestamp, weather_data.tmp_in, weather_data.hum_in, weather_data.tmp_out, 
            weather_data.hum_out, air_data.pm25, air_data.pm10, weather_data.weather_desc, vent_status);
